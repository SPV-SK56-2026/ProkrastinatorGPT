  ...
  return (
    <>
      ...
      <div id="titleContainer">
        ...
        <img src={icon("user")} id="registerIcon" alt="user" />
      </div>
        ...
        <form>
          <div className="registerContainer">
            ...
            <div className="inputWrapper">
              <input readOnly value="example@gmail.com" className='registerInput' type='email' />
              <img src={icon("padlock")} className="inputIcon" alt="lock" />
            </div>
          </div>
          <div className="registerContainer">
      ...
      <div className="btnWrapper">
        <button className="btnClose" onClick={() => setPage?.("home")}>Nazaj</button>
      </div>
      <Footer />
    </>
  )
